...
"""), _display_( /*6.2*/ main(Messages("sign.in.title")) /*6.33*/ {
    ...
    """), _display_( /*7.6*/ request /*7.13*/ .flash.get("error").map /*7.36*/ { msg =>
              _display_(Seq[Any](format.raw /*7.45*/ ("""
    ...
    """), format.raw /*13.5*/ ("""<fieldset class="col-md-6 col-md-offset-3">
        ...
        """), _display_( /*15.10*/ helper /*15.16*/ .form(action = routes.SignInController.submit()) /*15.64*/ {
              _display_(Seq[Any](format.raw /*15.66*/ ("""
        ...
        """), _display_( /*31.10*/ if (socialProviders.providers.nonEmpty) /*31.48*/ {
            ...
            """), format.raw /*32.13*/ ("""<div class="social-providers">
                ...
                <div>
                """), _display_( /*35.18*/ for (p <- socialProviders.providers if p.id != "clef") yield /*35.71*/ {
                _display_(Seq[Any](format.raw /*35.73*/ ("""
                ...
                """), _display_( /*39.18*/ defining(socialProviders.get[ClefProvider]) /*39.61*/ { clef =>
                _display_(Seq[Any](format.raw /*39.71*/ ("""
                    """), _display_( /*40.22*/ if (clef.isDefined) /*40.40*/ {
                  _display_(Seq[Any](format.raw /*40.42*/ ("""
...
/*
                  -- GENERATED --
                  DATE: Wed Jan 16 13:21:44 CET 2019
                  SOURCE: C:/Users/Tyrell Wellick/git/play-silhouette-seed/app/views/signIn.scala.html
