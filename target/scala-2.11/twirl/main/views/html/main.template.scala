            ...
            <div class="container">
                ...
                <nav class="collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        """),_display_(/*37.26*/user/*37.30*/.map/*37.34*/ { u =>_display_(Seq[Any](format.raw/*37.41*/("""
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        """),_display_(/*55.26*/user/*55.30*/.map/*55.34*/ { u =>_display_(Seq[Any](format.raw/*55.41*/("""
                        ...
                        """)))}/*58.26*/.getOrElse/*58.36*/ {_display_(Seq[Any](format.raw/*58.38*/("""
