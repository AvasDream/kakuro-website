      ...
      <div class="row justify-content-center">
          <div class="col-lg-6">
              <table class="table table-bordered table-dark">
                  ...
                  <tbody>
                  """), _display_( /*40.20*/ for (row <- 0 until 8) yield /*40.41*/ {
              _display_(Seq[Any](format.raw /*40.43*/ ("""
                      """), format.raw /*41.23*/ ("""<tr>
                          <th class="align-content-center" scope="row">"""), _display_( /*42.73*/ (row + 1)), format.raw /*42.82*/ ("""</th>
                              <div>
                                  """), _display_( /*44.36*/ for (col <- 0 until 8) yield /*44.57*/ {
                _display_(Seq[Any](format.raw /*44.59*/ ("""
                                      """), _display_( /*45.40*/ if (fieldMap.get(row.toString + "." + col.toString).get == 1) /*45.100*/ {
                  _display_(Seq[Any](format.raw /*45.102*/ ("""
                                          """), format.raw /*46.43*/ ("""<td class="align-middle" id=""""), _display_( /*46.73*/ row), format.raw /*46.76*/ ("""."""), _display_( /*46.78*/ col), format.raw /*46.81*/ (""""></td>
                                      """)))
                }), format.raw /*47.40*/ ("""
                                      """), _display_( /*48.40*/ if (fieldMap.get(row.toString + "." + col.toString).get == 2) /*48.100*/ {
                  _display_(Seq[Any](format.raw /*48.101*/ ("""
                                      ...
                                      """), _display_( /*64.40*/ if (fieldMap.get(row.toString + "." + col.toString).get == 0) /*64.100*/ {
                  _display_(Seq[Any](format.raw /*64.101*/ ("""
...
/*
                  -- GENERATED --
                  DATE: Wed Jan 16 16:06:48 CET 2019
                  SOURCE: C:/Users/Tyrell Wellick/git/play-silhouette-seed/app/views/kakuro.scala.html
